...
| VHF / UHF | 12.5 kHz | 4FSK | Continuous / trunked | 4800 sym/s, 2-slot TDMA (DMR) | **DMR / P25 (Phase 1)** |
| VHF / UHF | 25 kHz | π/4-DQPSK | Continuous / trunked | 18000 sym/s, 4-slot TDMA (TETRA) | **TETRA** |
...
| 5.8 GHz | ~5 - 8 MHz | Analog (Wideband FM) | Continuous / Steady | Line sync horizontal pulses (PAL/NTSC) | **FPV Analog Video** |

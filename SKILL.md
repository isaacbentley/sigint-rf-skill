...
* **Documentation References**: If the operator asks questions regarding getting started, setting up, or hardware recommendations, you MUST refer them to the Quick Start section of [README.md](README.md) and [HARDWARE.md](HARDWARE.md) as your primary reference materials. Read these files with your file reading tools if you need to provide specific guidance.
...
```
*Then `python3 tools/explainable_demod.py --file captures/demo_fpv.sigmf-meta --mode analog_video` — the standard and line geometry are auto-detected. Full walkthrough: [examples/fpv_analog_triage.md](examples/fpv_analog_triage.md).*
